...
<body>
	...
	<c:if test="${candPers ne null}">
		<form:form action="savepersonal.htm" modelAttribute="candPers"
			method="post">

			<form:label path="candidateName">Name</form:label>
			<form:input path="candidateName" pattern="[A-Za-z\s]+"
				required="required" maxlength="20"></form:input>
...
<form:errors path="gender"></form:errors>
			...
			<form:errors path="passportNumber"></form:errors>
			<br />
	...
	<c:if test="${candQual ne null }">
		...
		<form:form action="savequal.htm" modelAttribute="candQual"
			method="post">
			<table border="1">
				<tr>
	...
	<a href="addworkform.htm">Add Work History Details</a>
	<c:if test="${candWork ne null }">
		<h2>Enter Work History Details</h2>
		<form:form action="saveworkhist.htm" modelAttribute="candWork"
			method="post">
			<table border="1">
				<tr>
					<th><form:label path="whichEmployer">Qualification</form:label></th>
					...
					<th><form:label path="hrRepContactNumber">On a scale of</form:label></th>
				</tr>

				<tr>
					<td><form:input path="whichEmployer"
							pattern="^[A-Z]{1}[a-z]{1,}[1-9]{0,}$" required="TRUE"
							title="Previous1"></form:input>
						<form:errors path="whichEmployer"></form:errors></td>
					...
					<td><form:textarea path="reasonForLeaving"></form:textarea>
						<form:errors path="reasonForLeaving"></form:errors></td>
					<td><form:textarea path="responsibilities" />
						<form:errors path="responsibilities"></form:errors></td>
